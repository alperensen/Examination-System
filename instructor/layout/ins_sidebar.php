...
<div class="bg-dark" id="sidebar-wrapper">
    <div class="sidebar-heading bg-dark text-white ps-3">
        <a href="Instructor_home.php" class="text-white text-decoration-none">Exam System</a>
    </div>
    <div class="list-group list-group-flush">
        ...
        <a class="list-group-item list-group-item-action list-group-item-light p-3" href="Instructor_add_course.php"><i class="fa-solid fa-plus" style="margin-right: 0.5rem;"></i>Add Course</a>
